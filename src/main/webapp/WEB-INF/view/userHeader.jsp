<%@page import="com.grocery.entity.CartEntity"%>
...
<% 
    ...
    int cartItems=cartEntity.getProductEntities().size();
...
<nav class="navbar navbar-expand-lg navbar-dark  fixed-top" id="mainNav" style="background:#6b63a7">
	...
	<div class="collapse navbar-collapse" id="navbarResponsive" >
		...
		<ul class="navbar-nav ml-auto">
		    ...
		    <li class="nav-item active" title="My Cart"><a class="nav-link" href="../checkOut"><i class="fa fa-fw fa-shopping-cart" aria-hidden="true"></i>&nbsp<sup>${items}</sup>
	            <span class="sr-only">(current)</span>
			</a></li>
