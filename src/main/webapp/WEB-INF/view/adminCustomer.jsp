			...
			<div class="card-body">
				<form action="" method="GET">
					<div class="table-responsive">
						<table class="table table-bordered" id="customerJsonData">
							<thead>
								...
								.dataTable(
										{
											...
											"sAjaxSource" : "customers.web", // action
											"aoColumns" : [
													{
														"mData" : "customerId"
													},
													...
													},
													{
														...
														"render" : function(mData, type, row, meta) {
															if (type === 'display') {
																data = '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a style="color: red" href="#"><i title="View" class="fa fa-eye"></i></a>';
															}
															return data;
														}
													}
