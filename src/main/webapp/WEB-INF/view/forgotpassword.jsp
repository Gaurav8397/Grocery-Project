	...
	<header>
		...
		<div class="view" style="background-image: url('images/grocery.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center; position: absulate">
          ...
          <div class="card-body">
           ...
           <form:form modelAttribute="forgotPassForm" action="../forgotpassword" method="POST">
          <div class="form-group">
            <form:input  class="form-control" name="email" id="email" path="email" type="email" aria-describedby="emailHelp" placeholder="Enter email address" />
          </div>
